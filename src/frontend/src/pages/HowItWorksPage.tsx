...
const STEPS = [
  {
    ...
    description:
      "Select your sport and go live. Nearby buddies can see you're ready to play.",
  },
  {
    id: "scan",
    ...
    description:
      "Scan QR codes at events, venues, and partner locations to earn Sport Buddy Coins.",
  },
  {
    id: "attend",
    icon: <Users className="w-5 h-5" />,
    title: "Attend Events",
    description:
      "Join events and mark your attendance to earn +5 coins per event.",
  },
  {
    id: "redeem",
    ...
    description:
      "Use your coins to redeem gear, experiences, and exclusive rewards in the store.",
  },
];
