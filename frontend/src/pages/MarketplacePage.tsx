...
const MARKETPLACE_ITEMS = [
  { id: "1", title: "Nike Soccer Cleats (Size 10)", price: 120, seller: "Alex R.", sport: "soccer" },
  { id: "2", title: "Wilson Tennis Racket", price: 85, seller: "Jordan M.", sport: "tennis" },
  { id: "3", title: "Basketball (Official Size)", price: 45, seller: "Sam K.", sport: "basketball" },
  { id: "4", title: "Yoga Mat (Premium)", price: 35, seller: "Casey L.", sport: "yoga" },
  { id: "5", title: "Cycling Helmet", price: 60, seller: "Taylor B.", sport: "cycling" },
];

const PRO_SHOPS = [
  { id: "1", name: "City Sports Hub", sports: ["soccer", "basketball"], distance: "0.4 mi" },
...
export default function MarketplacePage() {
  ...
  const handlePostItem = () => {
    toast.info("Post an item: Feature coming soon. You'll be able to list gear for sale.");
  };
              ...
              >
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground capitalize">{item.sport} · {item.seller}</p>
                  </div>
