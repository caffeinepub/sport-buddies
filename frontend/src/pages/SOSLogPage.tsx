...
export default function SOSLogPage() {
  ...
  return (
    <main style={{ marginTop: '56px', padding: '16px', minHeight: 'calc(100vh - 56px)', paddingBottom: '32px' }}>
        ...
        <div className="mb-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div className="flex-1">
              <h1 className="text-2xl font-bold text-foreground">Emergency Log</h1>
              <p className="text-sm text-muted-foreground">Private device log</p>
            </div>
          </div>
        </div>
                ...
                <CardHeader>
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <CardTitle className="text-lg">Emergency #{logs.length - index}</CardTitle>
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        ...
                        <div className="font-medium">{formatTime(log.startedAt)}</div>
                      </div>
                      <div>
      ...
      <AlertDialog open={showClearModal} onOpenChange={setShowClearModal}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete all emergency event records from this device. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel onClick={cancelClearLog}>Cancel</AlertDialogCancel>
            <AlertDialogAction onClick={confirmClearLog} className="bg-destructive hover:bg-destructive/90">
              Clear Log
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
