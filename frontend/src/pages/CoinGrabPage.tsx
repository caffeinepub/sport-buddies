...
export default function CoinGrabPage() {
  ...
  return (
    <main style={{ marginTop: '56px', padding: '16px', minHeight: 'calc(100vh - 56px)', paddingBottom: '80px' }}>
      {/* Header */}
      <div className="flex items-center gap-3 mb-6">
        <button
          onClick={() => navigate({ to: '/coins' })}
        ...
        <div className="flex items-center justify-center" style={{ minHeight: 'calc(100vh - 200px)' }}>
          ...
          >
            <CardContent className="pt-8 pb-8 px-6">
              ...
              {/* Title */}
              <h3 className="text-xl font-bold text-center mb-3" style={{ color: '#FFFFFF' }}>
                Camera Access Required
              </h3>

              {/* Description */}
              <p className="text-center mb-6" style={{ color: 'rgba(255,255,255,0.8)', lineHeight: '1.6' }}>
                Sport Buddies uses your camera only to scan official QR codes for coin rewards.
              </p>
              ...
              <Button
                ...
                className="w-full"
                style={{
                  backgroundColor: (!canStartScanning || isLoading) ? 'rgba(212,175,55,0.3)' : '#D4AF37',
                  color: '#0B0B0D',
                  fontWeight: 'bold',
                  padding: '12px',
                }}
          ...
          >
            <CardContent className="pt-8 pb-8 px-6 text-center">
              ...
              <Button
                ...
                className="w-full"
                style={{
                  backgroundColor: isLoading ? 'rgba(212,175,55,0.3)' : '#D4AF37',
                  color: '#0B0B0D',
                  fontWeight: 'bold',
                }}
              >
          ...
          >
            <CardContent className="pt-4 pb-4 px-6">
              <p className="text-sm text-center" style={{ color: 'rgba(255,255,255,0.7)' }}>
                Point your camera at a Sport Buddies QR code to scan and earn coins.
              </p>
            </CardContent>
          </Card>
        </div>
