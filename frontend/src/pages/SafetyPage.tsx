...
export default function SafetyPage() {
  ...
  const handleLearnEmergency = () => {
    toast.info("Emergency Shield: Press and hold the shield button for 2 seconds to activate. Buddies and emergency contacts will be notified.");
  };

  const handleSetupNotifications = () => {
    toast.info("Notification setup coming soon. You'll be able to configure buddy alerts and emergency notifications.");
  };

  const handleLearnNotifications = () => {
    toast.info("Emergency Notifications: When activated, your buddies and emergency contacts receive your location and a distress alert.");
  };
    ...
    <div className="min-h-screen bg-background pb-24">
      <div className="px-4 pt-6 space-y-6">
        ...
        <div className="bg-card border border-border rounded-xl p-4 space-y-4">
          ...
          <div className="text-center space-y-1">
            ...
            <p className="text-sm text-muted-foreground">
              Activate your personal emergency shield to alert buddies and contacts.
            </p>
          </div>
        ...
        <div className="bg-card border border-border rounded-xl p-4 space-y-4">
          ...
          <div className="text-center space-y-1">
            <h2 className="font-semibold text-foreground">Emergency Notifications</h2>
            <p className="text-sm text-muted-foreground">
              Configure who gets notified when you activate your emergency shield.
            </p>
          </div>
          <div className="flex gap-3">
            <button
