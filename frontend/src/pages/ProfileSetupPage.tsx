...
import { Sport, SkillLevel } from '../backend';
...
export default function ProfileSetupPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center p-4 pt-20 pb-4">
      <Card className="w-full max-w-md" style={{ backgroundColor: '#141418', borderColor: 'rgba(255,255,255,0.08)' }}>
        <CardHeader>
          <CardTitle className="text-2xl" style={{ color: '#FFFFFF' }}>Complete Your Profile</CardTitle>
