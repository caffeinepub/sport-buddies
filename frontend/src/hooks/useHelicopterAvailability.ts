...
export function useHelicopterAvailability(startTime: string, endTime: string, enabled: boolean = false) {
  ...
  return useQuery<AvailabilityResponse>({
    ...
    queryFn: async () => {
      ...
      try {
        const response = await actor.checkHelicopterAvailability(startTime, endTime);
